...
Source0  : https://gmic.eu/files/source/gmic_3.5.3.tar.gz
...
%prep
%setup -q -n gmic-3.5.3
cd %{_builddir}/gmic-3.5.3
pushd ..
cp -a gmic-3.5.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742409031
mkdir -p clr-build
pushd clr-build
