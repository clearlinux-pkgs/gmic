...
Source0  : https://gmic.eu/files/source/gmic_3.5.4.tar.gz
...
%prep
%setup -q -n gmic-3.5.4
cd %{_builddir}/gmic-3.5.4
pushd ..
cp -a gmic-3.5.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746223961
mkdir -p clr-build
pushd clr-build
